        ...
        <div className='max-w-6xl mx-auto'>
          <div className='flex justify-center mb-6'>
            <div className='bg-gray-100 text-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
              <HiSparkles size={18} className='bg-green-100 text-green-600' />
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {steps_list.map((item, index) => (
              <motion.div key={index}
                ...
                className={`relative bg-white rounded-3xl border border-green-100 hover:border-green-500
                 p-10 max-w-[90%] shadow-md hover:shadow-2xl transition-all duration-300
                 ${index === 0 ? "rotate-[-4deg]" : ""}
