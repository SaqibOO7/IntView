...
function Step2Interview({ interviewData, onFinish }) {
  ...
  // Understand this below code through chatgpt
  useEffect(() => {
    const loadVoices = () => {
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-emerald-50 via-white to-teal-100 flex items-center
      ...
      flex flex-col lg:flex-row overflow-hidden'>
        ...
        <div className='w-full lg:w-[35%] bg-white flex flex-col items-center p-6 space-y-6 border-r border-gray-200'>
          ...
          {subtitle && (
            <div className='w-full max-w-md bg-gray-50 border border-gray-200 rounded-xl p-4 shadow-sm'>
              <p className='bg-gray-700 text-sm sm:text-base font-medium text-center leading-relaxed'>
                {subtitle}
              </p>
            </div>
          )}
        ...
        <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
          ...
          <div className='flex items-center gap-4 mt-6'>
            ...
            <motion.button
              whileTap={{ scale: 0.9 }}
              className='w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center rounded-full bg-black
